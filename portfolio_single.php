...
session_start();
$id = $_GET['person_id'];
$person_query = "SELECT * FROM portfolios WHERE id='$id'";
$person_img = mysqli_query($db_connect, $person_query);
$img = mysqli_fetch_assoc($person_img);
                    ...
                    <div class="col-xl-9 col-lg-10">
                        <div class="single-blog-list">
                            <div class="blog-list-thumb mb-35">
                                <img src="./images/portfolios/<?= $img['image'] ?>" alt="img">
                            </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="post-avatar-img">
                                            <img src="./images/portfolios/<?= $img['image'] ?>" style="width: 100px; height: 100px;" alt="img">
                                        </div>
